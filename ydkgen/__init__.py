...
def _filter_bundle_pkgs(bundle, api_pkgs):
    """ Filter api packages for bundle.
    ...
    """
    # filter bundle package by bundle name

    bundle_pkgs = set()
    for pkg in api_pkgs:
        if pkg.bundle_name == bundle.name:
