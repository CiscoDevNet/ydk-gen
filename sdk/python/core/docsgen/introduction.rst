...
YDK consists of two main components: core library, which consists of services and providers, and python bindings, which are APIs generated based on YANG models and packaged as bundles.
...
Applications can be written using the python bindings in conjunction with a service and a provider.
...
YDK performs the below actions when running this application:
 ...
 5. Any errors will result in python exceptions being raised
