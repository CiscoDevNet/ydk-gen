...
from ydk_ydktest.models.ydktest import ydktest_sanity as ysanity
...
class SanityYang(unittest.TestCase):
    ...
    def test_two_level_pos(self):
        # READ
        r_1 = ysanity.Runner()
        r_1.two.number, r_1.two.sub1.number = 2, 21
        ...
        # UPDATE
        r_1, r_2 = ysanity.Runner(), ysanity.Runner()
        r_1.two.number, r_1.two.sub1.number = 20, 210
        r_1.two.name = 'runner/two/name'
        self.crud.update(self.ncc, r_1)
        r_2 = self.crud.read(self.ncc, r_2)
        self.assertEqual(is_equal(r_1, r_2), True)
    ...
    def test_three_level_pos(self):
        # READ
        r_1 = ysanity.Runner()
        r_1.three.number, r_1.three.name = 3, 'runner:three:name'
        r_1.three.sub1.number, r_1.three.sub1.sub2.number = 31, 311
        self.crud.create(self.ncc, r_1)
        r_2 = ysanity.Runner()
        r_2 = self.crud.read(self.ncc, r_2)
        self.assertEqual(is_equal(r_1, r_2), True)
        # UPDATE
        r_1, r_2 = ysanity.Runner(), ysanity.Runner()
        r_1.three.number, r_1.three.name = 30, 'runner/three/name'
        r_1.three.sub1.number, r_1.three.sub1.sub2.number = 310, 3110
        self.crud.update(self.ncc, r_1)
        r_2 = self.crud.read(self.ncc, r_2)
        self.assertEqual(is_equal(r_1, r_2), True)
        # DELETE
    ...
    def test_onelist_neg_update_key_nonexist(self):
        ...
        e_1 = ysanity.Runner.OneList.Ldata()
        e_1.number = 1
        e_1.name = 'runner:onelist:ldata[%d]:name' % e_1.number
    ...
    def test_onelsit_pos(self):
        ...
        e_1.name = 'runner:onelist:ldata[%d]:name' % e_1.number
        e_2.number = 2
        e_2.name = 'runner:onelist:ldata[%d]:name' % e_2.number
        r_1.one_list.ldata.extend([e_1, e_2])
        self.crud.create(self.ncc, r_1)
        r_2 = self.crud.read(self.ncc, r_2)
        self.assertEqual(is_equal(r_1, r_2), True)
    ...
    def test_threelist_pos(self):
        ...
        e_1.number = 31
        e_1.name = 'runner:threelist:ldata[%d]:name' % e_1.number
        e_2 = ysanity.Runner.ThreeList.Ldata()
        e_2.number = 32
        e_2.name = 'runner:threelist:ldata[%d]:name' % e_2.number
        e_11 = ysanity.Runner.ThreeList.Ldata.Subl1()
        e_12 = ysanity.Runner.ThreeList.Ldata.Subl1()
        e_11.number = 311
        e_11.name = ('runner:threelist:ldata[%d]:subl1[%d]:name'
                     % (e_1.number, e_11.number))
        e_12.number = 312
        e_12.name = ('runner:threelist:ldata[%d]:subl1[%d]:name'
                     % (e_1.number, e_12.number))
        e_111 = ysanity.Runner.ThreeList.Ldata.Subl1.SubSubl1()
        e_112 = ysanity.Runner.ThreeList.Ldata.Subl1.SubSubl1()
        e_111.number = 3111
        e_111.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_1.number, e_11.number, e_111.number))
        e_112.number = 3112
        e_112.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_1.number, e_11.number, e_112.number))
        ...
        e_121.number = 3121
        e_121.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_1.number, e_12.number, e_121.number))
        e_122.number = 3122
        e_121.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_1.number, e_12.number, e_122.number))
        e_12.sub_subl1.extend([e_121, e_122])
        e_1.subl1.extend([e_11, e_12])
        e_21 = ysanity.Runner.ThreeList.Ldata.Subl1()
        e_22 = ysanity.Runner.ThreeList.Ldata.Subl1()
        e_21.number = 321
        e_21.name = ('runner:threelist:ldata[%d]:subl1[%d]:name'
                     % (e_2.number, e_21.number))
        e_22.number = 322
        e_22.name = ('runner:threelist:ldata[%d]:subl1[%d]:name'
                     % (e_2.number, e_22.number))
        e_211 = ysanity.Runner.ThreeList.Ldata.Subl1.SubSubl1()
        e_212 = ysanity.Runner.ThreeList.Ldata.Subl1.SubSubl1()
        e_211.number = 3211
        e_211.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_2.number, e_21.number, e_211.number))
        e_212.number = 3212
        e_212.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_2.number, e_21.number, e_212.number))
        ...
        e_221.number = 3221
        e_221.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_2.number, e_22.number, e_221.number))
        e_222.number = 3222
        e_222.name = ('runner:threelist:ldata[%d]:subl1[%d]:subsubl1[%d]:name'
                      % (e_2.number, e_22.number, e_222.number))
        ...
        e_12 = ysanity.Runner.ThreeList.Ldata.Subl1()
        e_11.number = 311
        e_11.name = ('runner/threelistldata[%d]/subl1[%d]/name'
                     % (e_1.number, e_11.number))
        e_12.number = 312
        e_12.name = ('runner/threelistldata[%d]/subl1[%d]/name'
                     % (e_1.number, e_12.number))
        e_111 = ysanity.Runner.ThreeList.Ldata.Subl1.SubSubl1()
        e_112 = ysanity.Runner.ThreeList.Ldata.Subl1.SubSubl1()
        e_111.number = 3111
        ...
        e_121.name = ('runner/threelist/ldata[%d]/subl1[%d]/subsubl1[%d]/name'
                      % (e_1.number, e_12.number, e_121.number))
        e_122.number = 3122
        e_122.name = ('runner/threelist/ldata[%d]/subl1[%d]/subsubl1[%d]/name'
                      % (e_1.number, e_12.number, e_122.number))
        e_12.sub_subl1.extend([e_121, e_122])
        e_1.subl1.extend([e_11, e_12])
        e_21 = ysanity.Runner.ThreeList.Ldata.Subl1()
    ...
    def test_InbtwList_pos(self):
        ...
        e_1.number = 11
        e_1.name = 'runner:inbtwlist:[%d]:name' % e_1.number
        e_1.subc.number = 111
        e_1.subc.name = 'runner:inbtwlist:[%d]:subc:name' % e_1.number
        e_2.number = 12
        e_2.name = 'runner:inbtwlist:[%d]:name' % e_2.number
        e_2.subc.number = 121
        e_2.subc.name = 'runner:inbtwlist:[%d]:name' % e_2.number
        ...
        e_1.name = 'runner/inbtwlist/[%d]/name' % e_1.number
        e_1.subc.number = 111
        e_1.subc.name = 'runnerinbtwlist/[%d]/subc/name' % e_1.number
        e_2.number = 12
        e_2.name = 'runner/inbtwlist/[%d]/name' % e_2.number
        e_2.subc.number = 121
        e_2.subc.name = 'runnerinbtwlist/[%d]/subc/name' % e_2.number
        e_11 = ysanity.Runner.InbtwList.Ldata.Subc.SubcSubl1()
        e_11.number = 111
        e_11.name = ('runner/inbtwlist/[%d]/subc/subcsubl1[%d]/name'
                     % (e_1.number, e_11.number))
    ...
    def test_leafref_pos(self):
        ...
        e_2.subc.number = 121
        e_1.subc.name = 'runner:inbtwlist[%d]:subc:name' % e_1.number
        e_2.subc.name = 'runner:inbtwlist[%d]:subc:name' % e_2.number
        e_11 = ysanity.Runner.InbtwList.Ldata.Subc.SubcSubl1()
        e_12 = ysanity.Runner.InbtwList.Ldata.Subc.SubcSubl1()
        e_11.number = 111
        e_12.number = 112
