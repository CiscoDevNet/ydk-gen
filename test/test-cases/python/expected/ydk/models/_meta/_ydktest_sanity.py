    ...
    'Runner.Ytypes.BuiltInT' : {
        'meta_info' : _MetaInfoClass('Runner.Ytypes.BuiltInT',
            ...
            _MetaInfoClassMember('enum-value', REFERENCE_ENUM_CLASS, 'YdkEnumTestEnum' , 'ydk.models.ydktest_sanity', 'YdkEnumTestEnum', 
                ...
                'enum_value',
                'ydktest-sanity', False),
            _MetaInfoClassMember('identity-llist', REFERENCE_LIST, 'BaseIdentity_Identity' , 'ydk.models.ydktest_sanity', 'BaseIdentity_Identity', 
                [], [], 
                '''                A leaf-list of identityref
                ''',
                'identity_llist',
                'ydktest-sanity', False),
            _MetaInfoClassMember('identity-ref-value', REFERENCE_IDENTITY_CLASS, 'BaseIdentity_Identity' , 'ydk.models.ydktest_sanity', 'BaseIdentity_Identity', 
                [], [], 
                '''                ''',
                'identity_ref_value',
                'ydktest-sanity', False),
